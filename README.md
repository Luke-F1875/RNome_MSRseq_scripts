...
- bedRmod_format_converter.Rmd takes this compressed civ file and generates the nine bedRmodv2 files uploaded to the RNome project. This script generates all known tRNA modifications MSRseq can detect for the given tRNA human isodecoders made by Tao Pan, University of Chicago 
